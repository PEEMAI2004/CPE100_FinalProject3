...
void createUsersBackup() {
    ...
    snprintf(backupfilename, sizeof(backupfilename), "Backups/%s-%s-users-backup.csv", datetime, usersfilename);
...
void createPhonesBackup() {
    ...
    // Create the backup file name
    char backupfilename[100];
    snprintf(backupfilename, sizeof(backupfilename), "Backups/%s-%s-phones-backup.csv", datetime, phonesfilename);
...
void createModelsBackup() {
    ...
    // Create the backup file name
    char backupfilename[100];
    snprintf(backupfilename, sizeof(backupfilename), "Backups/%s-%s-models-backup.csv", datetime, modelsfilename);
